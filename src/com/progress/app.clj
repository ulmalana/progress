(ns com.progress.app
  (:require [com.biffweb :as biff :refer [q]]
            [com.progress.middleware :as mid]
            [com.progress.ui :as ui]
            [com.progress.settings :as settings]
            [rum.core :as rum]
            [xtdb.api :as xt]
...
(defn notify-clients [{:keys [com.progress/chat-clients]} tx]
...
(defn ws-handler [{:keys [com.progress/chat-clients] :as ctx}]
  {:status 101
